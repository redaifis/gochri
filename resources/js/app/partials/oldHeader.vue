...
<div>
    <nav class="navbar bg-white shadow-sm flex-nowrap">
        ...
        <div class="links d-flex mr-2">
            ...
            <a href="#" @click="() => {categories = !categories; categorieId = null}" class="mr-3 px-3 mt-1 toggler rounded"><i class="fas fa-bars"></i></a>
            <a href="#" id="logo"><img src="/storage/images/assets/logo.svg" alt="logo"></a>
        </div>
                    ...
                    <div class="row py-2">
                        <div class="col-12 col-sm-6">
                            <div class="d-flex flex-column categories">
                                <a href="#" class="m-2 py-2 px-4 rounded d-flex justify-content-between align-items-center" v-for="categorie in items" :key="categorie.id" @click="categorieId = categorie.id">{{categorie.name}} <i class="fas fa-angle-right"></i></a>
                            </div>
                        </div>
